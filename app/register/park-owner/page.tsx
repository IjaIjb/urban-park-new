...
import IndividualOwnerReg from "./IndividualOwnerReg";
import CorporateOwnerReg from "./CorporateOwnerReg";
...
const Page = () => {
  ...
  const handleCorporateState = () => {
    // e.preventDefault();
    setAccountValues({
      individualElement: false,
      corpoarateElement: true,
    });
  };
...
<div className="grid md:grid-cols-2 gap-3 w-full">
                          <div className=" mb-3 relative">
                            ...
                            <Field
                              className="mt-1 block w-full h-10 border-[1px] border-[#E4E1E1]  px-3 rounded-[10px] focus:outline-primary "
                              name="city"
                              as="select"
                              // type="tel"
                              onChange={(
